 ...
 *******************************************************************************/
package org.eclipse.nebula.widgets.grid.wrapper.utils;
...
public final class DateTimeUtils {
    ...
    private static SimpleDateFormat shortDateTimeWithoutSemicolonDF = // getDateTimeShortFormatWithoutSemicolon
    new SimpleDateFormat("yyyy-MM-dd HH-mm", Locale.getDefault());
     ...
     * @return Localized time value in format yyyy-MM-dd HH-mm
     */
    public static String getDateTimeShortFormatWithoutSemicolon(Date time) {
        if (time == null) {
            return NOT_DEFINED_DATE;
        }
        return shortDateTimeWithoutSemicolonDF.format(time);
    }
