...
import org.eclipse.nebula.snippets.grid.wrapper.columns.ColorAgeColumn;
...
public class ColorGridSnippet {
    ...
    public static void main(String[] args) {
        ...
        columnsList.add(new ColorAgeColumn(Column.createColumn("age")));
