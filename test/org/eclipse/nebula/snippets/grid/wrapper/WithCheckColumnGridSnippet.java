...
/**
 * Grid with check column
 */
public class WithCheckColumnGridSnippet {

    private static Display display = new Display();

    private static class CheckedNodeFactory extends NodeFactory {
    ...
    public static void main(String[] args) {
        ...
        GridTable grid = new GridTable(shell, GridTable.DEFAULT_STYLE, new CheckedNodeFactory(), columnsList);

        grid.setData(TestDataProvider.getPeople());

        shell.setText("Grid with check column");
