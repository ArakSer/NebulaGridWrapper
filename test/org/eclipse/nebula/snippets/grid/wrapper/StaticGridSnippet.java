...
/**
 * Not sortable, resizeble and movable columns
 */
public class StaticGridSnippet {
    ...
    public static void main(String[] args) {
        ...
        columnsList.add(Column.createColumn("name").setMoveable(false).setResizeable(false).setSortable(false));
        columnsList.add(Column.createColumn("age").setWidth(50).setMoveable(false).setResizeable(false).setSortable(false));
        ...
        shell.setText("Not sortable, resizeble and movable columns");
