...
import org.eclipse.nebula.widgets.grid.wrapper.columns.StaticImageColumn;
 ...
 */
public class WithImageColumnGridSnippet {

    private static Display display = new Display();

    protected static final Image IMAGE_LOCK = ResourceManager.getImage("test/res/Lock.png");
    ...
    public static void main(String[] args) {
        ...
        columnsList.add(new StaticImageColumn(Column.createColumn("married"), IMAGE_LOCK));
        ...
        shell.setText("Grid with image column");
